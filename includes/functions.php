...
This is functions file of R Shortner. It contains all functions. Which are going to be used.
...
class RShortner
{
	...
	function RShortner()
	{
		...
		mysql_connect(MYSQL_HOST, MYSQL_USER, MYSQL_PASS) or die('Connection to database failed.' );
		mysql_select_db(MYSQL_DB) or die('Selection of database failed.');	
	}
	...
	{ 
		...
		// using a timestamp to pick the most recent id)
